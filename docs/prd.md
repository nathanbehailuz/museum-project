...
Pitch: **Type a thing. See how artists have pictured it across time.**

## 2. Scope

Release requirements: complete subject journey (search → Journey → inspect → All Works or Connections → share). Launch with ≥3 journey-ready subjects from Met tags after validation.

Out of scope: accounts, multiple museums, computer vision, IIIF, storing image files in Supabase Storage.

## 3. Main User Journey

1. Open search; see suggestions and an example journey.
2. Open a journey-ready subject → Journey chapters.
3. Inspect a work (`?artwork=`).
4. Browse All Works or Connections; share URL.

## 4. Functional Requirements (summary)

- F01–F02: Search autocomplete from validated terms.
- F03: Journey / browse-only / unavailable messaging.
- F05–F07: Journey, All Works, Connections on indexed data.
